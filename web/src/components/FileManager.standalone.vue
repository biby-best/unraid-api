...
<template>
  <div class="bg-background text-foreground border-border flex flex-col overflow-hidden rounded-lg border">
    <!-- Header -->
    <div class="border-border flex items-center justify-between border-b px-4 py-3">
      <h3 class="text-lg font-semibold">{{ title }}</h3>
      <button
        @click="refresh"
        class="text-muted-foreground hover:text-foreground inline-flex h-8 w-8 items-center justify-center rounded-md transition-colors hover:bg-accent"
        title="Refresh"
      >
